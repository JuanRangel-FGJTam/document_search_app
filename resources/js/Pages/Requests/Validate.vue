...
<template>
    <AppLayout title="Validación de solicitud">
        <div class="py-6">
            <div class="max-w-7xl mx-auto">
                <div class="bg-white shadow-md rounded-lg p-6">
                    <div class="w-full px-2 py-2">
                        <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Formulario de validación</h2>
        ...
        <ModalConfirmation :show="showModal" :maxWidth="modalMaxWidth" :closeable="modalCloseable" @close="closeModal"
            ...
            <template #content>
                La solicitud será aceptada definitivamente, no podrá ser modificada.
            </template>
        </ModalConfirmation>
    </AppLayout>
</template>
