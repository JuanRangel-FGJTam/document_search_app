...
function deleteSubBrand(id) {
    selectedSubId.value = id;
    confirmDelete.value = true;
}

function confirmDeleteBrand() {
    router.delete(route('vehicleSubBrand.delete', selectedSubId.value), {
        onSuccess: () => {
            toast.success('Sub Marca eliminada correctamente');
...
<template>
    <AppLayout title="SubMarcas de vehículos">
        <div class="py-6">
                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    ...
                    <div class="flex flex-col gap-4 p-4 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <div class="flex items-center gap-x-3">
                            ...
                            <h2 class="text-lg font-semibold leading-tight text-gray-800 uppercase dark:text-gray-200">
                                SubMarcas de vehículos
                            </h2>
                        </div>
                        <div>
                            <Link :href="route('vehicleSubBrand.create')"
                            ...
                            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                                <div>
                                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                        ...
                                        <tbody>
                                            <template v-if="subBrands.data.length > 0">
                                                <tr class="text-center border-b dark:border-gray-700"
                                                    v-for="subBrand in subBrands.data" :key="subBrand.id">
                                                    <th scope="row"
                                                    ...
                                                    <td class="px-4 py-3 items-center justify-center">
                                                        <div class="flex justify-center gap-2">
                                                            <Link :href="route('vehicleSubBrand.edit', subBrand.id)"
                                                            ...
                                                            <button @click="deleteSubBrand(subBrand.id)"
                                            ...
                                            <template v-else>
                                                <tr>
                                                    <td colspan="3"
                                                        ...
                                                        No hay submarcas de vehículos que mostrar.
                                                    </td>
                                                </tr>
                                            </template>
                                        ...
                                        <tfoot>
                                            <Pagination :colspan="3" :ObjectData="subBrands"></Pagination>
                                        </tfoot>
                                    </table>
                                </div>
                            </div>
                    ...
                    <div v-if="confirmDelete"
                        ...
                        <div class="bg-white rounded-lg p-6 w-full max-w-md shadow-lg">
                            <h3 class="text-lg font-semibold text-gray-800 mb-4">¿Estás seguro que deseas eliminar esta submarca de vehículo?</h3>
