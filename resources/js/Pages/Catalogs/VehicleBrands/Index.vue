            ...
            <div class="max-w-7xl mx-auto">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    ...
                    <div class="flex flex-col gap-4 p-4 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <div>
                            <Link :href="route('vehicleBrand.create')"
                                        ...
                                        <tbody>
                                            <template v-if="brands.data.length > 0">
                                                <tr class="text-center border-b dark:border-gray-700"
                                                    v-for="brand in brands.data" :key="brand.id">
                                                    <th scope="row"
                                            ...
                                            <template v-else>
                                                <tr>
                                                    <td colspan="2"
                                                        ...
                                                        No hay marcas de vehículos que mostrar.
                                                    </td>
                                                </tr>
                                            </template>
                                        </tbody>
                                        <tfoot>
                                            <Pagination :colspan="2" :ObjectData="brands"></Pagination>
                                        </tfoot>
                                    </table>
                                </div>
                            </div>
...
<div v-if="confirmDelete" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
    <div class="bg-white rounded-lg p-6 w-full max-w-md shadow-lg">
        <h3 class="text-lg font-semibold text-gray-800 mb-4">¿Estás seguro que deseas eliminar esta marca?</h3>
