...
const validateForm = () => {
    if ((form.reportType === 7 || form.reportType === 8) && !form.year) {
        toast.warning('Ingrese un año');
        return false;
    }
    if ((form.reportType === 6) && !form.start_date && !form.end_date) {
                    ...
                    <div class="w-full px-2 py-2">
                        ...
                        <form @submit.prevent="submit">
                            <div class="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
                                ...
                                <div class="col-span-1" v-if="[7, 8].includes(form.reportType)">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                        Seleccione Año
                                    </label>
                                ...
                                <div v-if="[6].includes(form.reportType)" class="col-span-1">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                        Fecha de Inicio
                                    </label>
                                ...
                                <div v-if="[7].includes(form.reportType)" class="col-span-1">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                ...
                                <div v-if="[8].includes(form.reportType)" class="col-span-1">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                        Seleccione tipo de vehículo
                                    </label>
                                    <select v-model="form.vehicle_type"
                                        class="border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5">
                                        <option disabled :value="null">Seleccione un tipo de vehículo</option>
                                        <option v-for="vehicle_type in vehicle_types" :key="vehicle_type.id"
