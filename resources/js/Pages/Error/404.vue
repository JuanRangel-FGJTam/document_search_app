        ...
        <section class="min-h-screen bg-white">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div
                    ...
                    <div class="border border-blue-900 h-[550px] rounded-lg w-full">
                        <div class="p-8 flex justify-between items-center border-b border-indigo-100">
                            <div class="block">
                                <svg width="204" height="18" viewBox="0 0 204 18" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="8.78677" cy="8.78677" r="8.78677" transform="matrix(1 0 0 -1 0 17.6912)"
                                        fill="#E0E7FF" />
                                    <circle cx="8.78677" cy="8.78677" r="8.78677"
                                        transform="matrix(1 0 0 -1 28.1177 17.6912)" fill="#A5B4FC" />
                                    <circle cx="8.78677" cy="8.78677" r="8.78677"
                                        transform="matrix(1 0 0 -1 56.2353 17.6912)" fill="#E0E7FF" />
                                    <path
                        ...
                        <div class="relative h-[calc(550px-85px)] flex justify-center items-center flex-col">
                            <svg width="314" height="171" viewBox="0 0 314 171" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                            ...
                            <div class="block text-center mt-5">
                                <h5 class="md:text-xl text-lg leading-8 text-gray-900 font-medium mb-1.5"><span
                                        class="text-blue-900 font-semibold ">Oops!</span>
                                    Parece que estas en un enlace incorrecto. </h5>
                                <p class="text-sm text-gray-500">Si crees que esto es un problema con
                                    nosotros, por favor contactanos..</p>
                            </div>
                        </div>
                    </div>
                </div>
