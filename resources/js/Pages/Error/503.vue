    ...
    <MainLayout>
        <section class="flex items-center justify-center h-screen bg-white dark:bg-gray-900">
            <div class="text-center max-w-lg px-6">
                <svg class="mx-auto mb-6 w-16 h-16 text-gray-400 dark:text-gray-300" xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512">
                ...
                <p class="mt-4 text-gray-600 dark:text-gray-400 text-lg">
                    Nuestros administradores están trabajando para mejorar la experiencia de usuario. Por favor, vuelve más tarde.
                </p>
            </div>
        </section>
    </MainLayout>
